  ...
  return <ScrollView style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.uploadContainer}>
          <Image source={require("./assets/shield.png")} style={styles.uploadImg} />
        </View>
      </View>
      ...
      <View style={styles.feeContainer}>
        <View>
          <Text style={[styles.mr10, styles.RotNTZzx]}>Date issued</Text>
          <View style={styles.feeSection}>
            <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
          </View>
        </View>
        <View>
          <Text style={[styles.mr10, styles.rmOFVgiR]}>Exp. Date</Text>
          <View style={styles.feeSection}>
            <TextInput placeholder="Enter" placeholderTextColor={"#000"} />
          </View>
        </View>
      ...
      <View style={styles.skipSection}>
        <Text style={styles.WbPKPeAY}>Skip for now</Text>
        <Image source={require("./assets/skip.png")} style={styles.skipImg} />
      </View>
    </ScrollView>;
};
